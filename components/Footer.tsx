...
export default function Footer() {
  return (
    <>
      <div className="w-full min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-fuchsia-200 mt-36 px-5">
        <div className="md:w-2/3 w-full px-4flex flex-col">
          <div className="w-full text-7xl font-bold">
            <h1 className={`w-full md:w-2/3 ${runner.className} clamp-text `}>
              We don&apos;t do basic—only legendary
            </h1>
          </div>
          <div className="flex mt-8 flex-col md:flex-row md:justify-between">
            ...
            <div className="w-44 pt-6 md:pt-0">
              <button className=" text-white font-bold text-lg bg-black rounded-full hover:bg-gray-800 transition duration-300 ease-in-out">
                Book an appointment
              </button>
            </div>
          </div>
